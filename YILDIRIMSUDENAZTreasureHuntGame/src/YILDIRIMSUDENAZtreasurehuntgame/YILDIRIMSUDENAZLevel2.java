 ...
 * @author ASUS
 */
public class YILDIRIMSUDENAZLevel2 extends javax.swing.JFrame {
    ...
    public YILDIRIMSUDENAZLevel2(String username) {
    ...
    private void setupBoard() {
        ...
        YILDIRIMSUDENAZNode current = null;
    ...
    private void writeScoreToFile(String username, int score) {
        try {
            ...
            out.println(username + ",level2," + score);
            out.close();
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        btn1.setText("1 ");
        jPanel1.add(btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, -1, 30));

        btn2.setText("2 ");
        jPanel1.add(btn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, -1, -1));

        btn3.setText("3 ");
        jPanel1.add(btn3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 440, -1, -1));

        btn4.setText("4 ");
        jPanel1.add(btn4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 430, -1, -1));

        btn5.setText("5 ");
        jPanel1.add(btn5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 450, -1, -1));

        btn6.setText("6 ");
        jPanel1.add(btn6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 480, -1, -1));

        btn7.setText("7 ");
        jPanel1.add(btn7, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 480, -1, -1));

        btn8.setText("8 ");
        jPanel1.add(btn8, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 440, -1, -1));

        btn9.setText("9 ");
        jPanel1.add(btn9, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 400, -1, -1));

        btn10.setText("10");
        jPanel1.add(btn10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 370, -1, -1));

        btn11.setText("11");
        jPanel1.add(btn11, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 420, -1, -1));

        btn12.setText("12");
        jPanel1.add(btn12, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, -1, -1));

        btn13.setText("13");
        jPanel1.add(btn13, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 280, -1, -1));

        btn14.setText("14");
        jPanel1.add(btn14, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 220, -1, -1));

        btn15.setText("15");
        jPanel1.add(btn15, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 170, -1, -1));

        btn16.setText("16");
        jPanel1.add(btn16, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 170, -1, -1));

        btn17.setText("17");
        jPanel1.add(btn17, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 190, -1, -1));

        btn18.setText("18");
        jPanel1.add(btn18, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 230, -1, -1));

        btn19.setText("19");
        jPanel1.add(btn19, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 270, -1, -1));

        btn20.setText("20");
        jPanel1.add(btn20, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 310, -1, -1));

        btn21.setText("21");
        jPanel1.add(btn21, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 350, -1, -1));

        btn22.setText("22");
        jPanel1.add(btn22, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 390, -1, -1));

        btn23.setText("23");
        jPanel1.add(btn23, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 440, -1, -1));

        btn24.setText("24");
        jPanel1.add(btn24, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 490, -1, -1));

        btn25.setText("25");
        jPanel1.add(btn25, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 530, -1, -1));

        btn26.setText("26");
        jPanel1.add(btn26, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 570, -1, -1));

        btn27.setText("27");
        jPanel1.add(btn27, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 570, -1, -1));

        btn28.setText("28");
        jPanel1.add(btn28, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 550, -1, -1));

        btn29.setText("29");
        jPanel1.add(btn29, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 520, -1, -1));

        btn30.setText("30");
        jPanel1.add(btn30, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 480, -1, -1));
        ...
        jPanel1.add(dice_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 80, -1, -1));

        score_lbl.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jPanel1.add(score_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 270, 110, 30));

        currentspot_lbl.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jPanel1.add(currentspot_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 300, 180, 30));

        diceshow_lbl.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jPanel1.add(diceshow_lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 110, 110, 20));

        lvl1_back_lbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/YILDIRIMSUDENAZtreasurehuntgame/images/lvl2yeni.png"))); // NOI18N
    ...
    private void dice_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dice_btnActionPerformed
        ...
        if (list.lastPlayerNode != null) {
            int index = list.getPlayerIndexFromNode(list.lastPlayerNode);
            renkUygula(list.lastPlayerNode.type, index);
        }
        ...
        if (list.getPlayerIndex() == buttons.length - 1) {
            ...
            if (secim == JOptionPane.YES_OPTION) {
                new YILDIRIMSUDENAZLevel3(username).setVisible(true);
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YILDIRIMSUDENAZLevel2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YILDIRIMSUDENAZLevel2().setVisible(true);
            }
        });
    }
